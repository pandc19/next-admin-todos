...
export const ProductCard = ({ id, name, price, rating, image }: Props) => {
    ...
    return (
        <div className="shadow rounded-lg max-w-sm bg-gray-800 dark:border-gray-100">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex">
                        ...
                        <button onClick={onRemoveFromCart}
                            className="text-white  hover:bg-red-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-red-600 dark:hover:bg-red-700 focus:ring-red-800">
